...
//! for sets without any entries, sets with 100 non-matching entries, and sets with matching entries.
...
#[bench]
fn vec_iter_10_sorted_failing_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(10);
    list.sort();
...
#[bench]
fn vec_iter_10_unsorted_failing_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(10);
    let set: HashSet<i64> = get_set(10, 100);
...
#[bench]
fn vec_iter_50_sorted_failing_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(50);
    list.sort();
...
#[bench]
fn vec_iter_50_unsorted_failing_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(50);
    let set: HashSet<i64> = get_set(50, 100);
...
#[bench]
fn vec_iter_100_sorted_failing_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(100);
    list.sort();
...
#[bench]
fn vec_iter_100_unsorted_failing_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(100);
    let set: HashSet<i64> = get_set(100, 100);
...
#[bench]
fn vec_iter_500_sorted_failing_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(500);
    list.sort();
...
#[bench]
fn vec_iter_500_unsorted_failing_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(500);
    let set: HashSet<i64> = get_set(500, 100);
...
#[bench]
fn vec_iter_1000_sorted_failing_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(1_000);
    list.sort();
...
#[bench]
fn vec_iter_1000_unsorted_failing_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(1_000);
    let set: HashSet<i64> = get_set(1_000, 100);
...
#[bench]
fn vec_iter_5000_sorted_failing_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(5_000);
    list.sort();
...
#[bench]
fn vec_iter_5000_unsorted_failing_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(5_000);
    let set: HashSet<i64> = get_set(5_000, 100);
...
#[bench]
fn vec_iter_10000_sorted_failing_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(10_000);
    list.sort();
...
#[bench]
fn vec_iter_10000_unsorted_failing_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(10_000);
    let set: HashSet<i64> = get_set(10_000, 100);
...
#[bench]
fn vec_iter_50000_sorted_failing_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(50_000);
    list.sort();
...
#[bench]
fn vec_iter_50000_unsorted_failing_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(50_000);
    let set: HashSet<i64> = get_set(50_000, 100);
...
#[bench]
fn vec_iter_100000_sorted_failing_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(100_000);
    list.sort();
...
#[bench]
fn vec_iter_100000_unsorted_failing_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(100_000);
    let set: HashSet<i64> = get_set(100_000, 100);
...
#[bench]
fn vec_iter_10_sorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(10);
    list.sort();
...
#[bench]
fn vec_iter_10_unsorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(10);
    let set: HashSet<i64> = get_set(0, 10);;
...
#[bench]
fn vec_iter_50_sorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(50);
    list.sort();
...
#[bench]
fn vec_iter_50_unsorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(50);
    let set: HashSet<i64> = get_set(0, 50);;
...
#[bench]
fn vec_iter_100_sorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(100);
    list.sort();
...
#[bench]
fn vec_iter_100_unsorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(100);
    let set: HashSet<i64> = get_set(0, 100);;
...
#[bench]
fn vec_iter_500_sorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(500);
    list.sort();
...
#[bench]
fn vec_iter_500_unsorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(500);
    let set: HashSet<i64> = get_set(0, 500);;
...
#[bench]
fn vec_iter_1000_sorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(1_000);
    list.sort();
...
#[bench]
fn vec_iter_1000_unsorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(1_000);
    let set: HashSet<i64> = get_set(0, 1_000);;
...
#[bench]
fn vec_iter_5000_sorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(5_000);
    list.sort();
...
#[bench]
fn vec_iter_5000_unsorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(5_000);
    let set: HashSet<i64> = get_set(0, 5_000);;
...
#[bench]
fn vec_iter_10000_sorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(10_000);
    list.sort();
...
#[bench]
fn vec_iter_10000_unsorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(10_000);
    let set: HashSet<i64> = get_set(0, 10_000);;
...
#[bench]
fn vec_iter_50000_sorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(50_000);
    list.sort();
...
#[bench]
fn vec_iter_50000_unsorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(50_000);
    let set: HashSet<i64> = get_set(0, 50_000);;
...
#[bench]
fn vec_iter_100000_sorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let mut list: Vec<i64> = get_unsorted_list_of_size(100_000);
    list.sort();
...
#[bench]
fn vec_iter_100000_unsorted_succeeding_containment_checks(bencher: &mut Bencher) {
    let list: Vec<i64> = get_unsorted_list_of_size(100_000);
    let set: HashSet<i64> = get_set(0, 100_000);;
